...
//seed instancia tempo_limite saida taxa_resfriamento sa_max temp_inicial temp_congelamento
...
{
   /* 
   haviam 2 possibilidades de gerar vizinho, porém nos testes utilizando 
   somente uma foi obtido um resultado melhor 
   */
   //if (num)
   //{
      int requisicao;
